...
## Cel
Demonstrate that RNG engine choice has no material effect on kQSketchShifted performance or accuracy. Measures both mean addition time and mean relative error across the four supported RNG engines (PCG64, MT19937, XOSHIRO128PP, XOSHIRO256PP). Results are presented as representative of all Fisher-Yates-based sketches.
...
## Oczekiwany wniosek
All four RNG engines produce essentially identical timing and accuracy curves, confirming that kQSketchShifted — and by extension all Fisher-Yates-based sketches — is indifferent to RNG engine choice.
